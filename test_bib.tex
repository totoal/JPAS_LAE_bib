...
\begin{itemize}
    ...
    \item Width of the QSO lines. \cite{Greig2016}
    \item Detecting ELG with ANN in miniJPAS. \cite{Martinez-Solaeche2021}
    \item LAEs NB survey. \cite{Fujita2003}
    \item LAEs NB survey. \cite{Santos2016}
    \item LAEs NB survey. \cite{Ouchi2008}
\end{itemize}
